  ...
  return (
    ...
    >
      <header className="text-[--dark-navy]  desktop:max-w-[448px] tablet:max-w-[448px] ">
        <h1 className="font-light text-[2.5rem] leading-[48px] desktop:text-6xl tablet:text-6xl">
          Welcome to the <span className="font-medium">Frontend Quiz!</span>
        </h1>
        <p className="text-[--gray-navy] italic text-sm mt-4 desktop:text-xl tablet:text-xl">
